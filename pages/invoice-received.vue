...
const {
    ...
    pagesList,
    fetch
} = useCrud<Invoice>('invoice-received', { take: 10 })
...
<template>
    ...
    <div class="overflow-x-scroll h-[100vh] pt-[40px] px-[20px]" >
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white mb-[20px]">Invoice Received</h5>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                >
                    ...
                    <td class="px-6 py-4">
                        {{ item.supplier?.party_legal_entity.registration_name }}
                    </td>
                    <td class="px-6 py-4">
